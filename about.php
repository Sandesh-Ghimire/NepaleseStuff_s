...
<div>
    ...
    <div class="container py-5">
        ...
        <div class="col-lg-6">
            ...
            <p class="lead text-muted mb-0">We are providing easy navigation,relaible,updated information to users of all kind who seeks the information about our country Nepal.</p>
    ...
    <div class="container py-5">
        ...
        <div class="col-lg-6 order-2 order-lg-1"><i class="fa fa-bar-chart fa-2x mb-3 text-primary"></i>
            ...
            <p class="font-italic text-muted mb-4">We are young students who are doing engeneering in the field of computer science so that we can deliver our ideas into the real world.So we come up with the idea of providing such platform for Nepal where we can find almost all info about Nepal.</p><a href="#" class="btn btn-light px-5 rounded-pill shadow-sm">Learn More</a>
        </div>
        ...
        <div class="col-lg-6"><i class="fa fa-leaf fa-2x mb-3 text-primary"></i>
            ...
            <p class="font-italic text-muted mb-4">We came from different background to achieve same goal that is making impact to real world problem.We are Nepalese, our team contains only 3 members.</p><a href="#" class="btn btn-light px-5 rounded-pill shadow-sm">Learn More</a>
        </div>
        </div>
    </div>
    </div>
    ...
    <div class="container py-5">
        ...
        <div class="col-lg-5">
            ...
            <p class="font-italic text-muted">Amazing team.</p>
        </div>
        </div>
